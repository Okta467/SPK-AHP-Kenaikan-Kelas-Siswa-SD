<?php
    ...
    try {
        ...
        mysqli_stmt_bind_param($stmt_guru, 'iiiissssssi', $id_jabatan, $id_pangkat_golongan, $id_pendidikan, $id_jurusan, $nip, $nama_guru, $jk, $alamat, $tmp_lahir, $tgl_lahir, $tahun_ijazah);
        ...
        $query_pengguna = "INSERT INTO tbl_pengguna (id_guru, username, password, hak_akses) VALUES (?, ?, ?, ?)";
        ...
        $id_guru = mysqli_insert_id($connection);
        mysqli_stmt_bind_param($stmt_pengguna, 'isss', $id_guru, $username, $password, $hak_akses);
