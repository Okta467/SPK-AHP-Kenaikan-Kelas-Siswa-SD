<?php
    ...
    mysqli_stmt_prepare($stmt, "INSERT INTO tbl_sub_kriteria (id_kriteria, kode_sub_kriteria, nama_sub_kriteria, bobot) VALUES (?, ?, ?, ?)");
    mysqli_stmt_bind_param($stmt, 'issd', $id_kriteria, $kode_sub_kriteria, $nama_sub_kriteria, $bobot);
