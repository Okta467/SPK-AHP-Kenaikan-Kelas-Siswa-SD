<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
    <a class="navbar-brand brand-logo mr-auto ml-3" href="index.html"><img class="mr-2" src="<?= base_url('assets/images/logo-mini.svg') ?>" alt="logo" /><span class="text-dark font-weight-bold"><?= strtoupper(SITE_NAME_SHORT) ?></span></a>
